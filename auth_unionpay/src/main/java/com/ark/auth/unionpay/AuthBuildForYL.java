...
public class AuthBuildForYL extends BaseAuthBuildForYL {
  ...
  private AuthBuildForYL(@NonNull Context context) {
    super(context);
  }
  ...
  @Override
  protected BaseAuthBuildForYL.Controller getController(@NonNull Activity activity) {
  ...
  @Override
  public void build(@Nullable AuthCallback callback) {
